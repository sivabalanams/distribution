...
Use this
[example YAML file](https://github.com/sivabalanams/distribution/blob/master/cmd/registry/config-example.yml)
as a starting point.
...
See
[config-example.yml](https://github.com/sivabalanams/distribution/blob/master/cmd/registry/config-example.yml)
